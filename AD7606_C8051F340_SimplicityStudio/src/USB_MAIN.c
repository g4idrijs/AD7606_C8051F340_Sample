...
code const U8 USB_MfrStr[] = {0x1A,0x03,'S',0,'i',0,'l',0,'i',0,'c',0,'o',0,'n',0,' ',0,'L',0,'a',0,'b',0,'s',0};
code const U8 USB_ProductStr[] = {0x10,0x03,'U',0,'S',0,'B',0,' ',0,'A',0,'P',0,'I',0};
code const U8 USB_SerialStr[] = {0x0A,0x03,'i',0,'d',0,'r',0,'i',0};
code const U8 USB_MaxPower = 15;
code const U8 USB_PwAttributes = 0x80; // Bus-powered, remote wakeup not supported
...
#define RATE	43000 //if LED_TOGGLE_RATE = 1, the LED will be on for 1 second and off for 1 second
